<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.gas_consuming_equipments.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            @can('create',
                            App\Models\GasConsumingEquipment::class)
                            <a
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($gasConsumingEquipments as
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $gasConsumingEquipment)
                                        <a
                                            href="{{ route('gas-consuming-equipments.edit', $gasConsumingEquipment) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $gasConsumingEquipment)
                                        <a
                                            href="{{ route('gas-consuming-equipments.show', $gasConsumingEquipment) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $gasConsumingEquipment)
                                        <form
                                            action="{{ route('gas-consuming-equipments.destroy', $gasConsumingEquipment) }}"
                                            method="POST"
